      ...
      <div className="py-8 border-t border-gray-700 items-center justify-between sm:flex">
        ...
        <div className="flex items-center gap-x-6 text-gray-400 mt-6">
          ...
          <a
            ...
            href="https://www.facebook.com/profile.php?id=61581263850786"
            target="_blank"
            rel="noopener noreferrer"
          >
            <svg
          ...
          <a className="text-red-600" href="javascript:void()">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="30"
              height="30"
              fill="currentColor"
              className="bi bi-youtube hover:text-gray-500 duration-150"
              viewBox="0 0 16 16"
            >
